---
created: 2023-11-21T18:49
updated: 2024-03-10T11:40
---
...
![截图.png](    8086汇编语言/media/image1.png)
...
![截图.png](    8086汇编语言/media/image2.png)

==带x的都是通用寄存器，带S的都是段寄存器==

AX,BX,CX,DX是通用的十六位 寄存器

![截图.png](    8086汇编语言/media/image3.png)

兼容：

 ![截图.png](    8086汇编语言/media/image4.png)height="3.268669072615923in"}
====
当十六位寄存器要兼容以前的八位寄存器的东西就需要吧十六位切一半然后不用的一半填0或者其他的

![截图.png](    8086汇编语言/media/image5.png)

当十六位的寄存器划分成两八位寄存器的时候样子，单独看十六位的是2万，分开就是分开的数值。

在AX中低八位是AL，高八位是AH.

![截图.png](    8086汇编语言/media/image6.png)
...
![截图.png](    8086汇编语言/media/image7.png)
...
![stickPicture.png](    8086汇编语言/media/image8.png)
...
![截图.png](    8086汇编语言/media/image9.png)
...
![截图.png](    8086汇编语言/media/image10.png)


CPU可以用不同的段地址和偏移地形成同一个物理地址

![截图.png](    8086汇编语言/media/image11.png)
...
例题：[(2)
有一数据存放在][内存](https://so.csdn.net/so/search?q=%E5%86%85%E5%AD%98&spm=1001.2101.3001.7020)[20000H单元中，现给定段地址为SA，若想用偏移地址寻到此单元。则SA应满足的条件是：最小为1001H
，最大为2000H 。]
...
![截图.png](    8086汇编语言/media/image12.png)
...
![截图.png](    8086汇编语言/media/image13.png)


![截图.png](    8086汇编语言/media/image14.png)
...
![截图.png](    8086汇编语言/media/image15.png)


D: 查看内存内容；

![截图.png](    8086汇编语言/media/image16.png)
...
![截图.png](    8086汇编语言/media/image17.png)


T: 执行一条机械指令；

![截图.png](    8086汇编语言/media/image18.png)


A:以汇编指令的格式在内存中写入一条机械指令；

![截图.png](    8086汇编语言/media/image19.png)


G:把程序直接运行完成

![截图.png](    8086汇编语言/media/image20.png)
...
![截图.png](    8086汇编语言/media/image21.png)
...
![截图.png](    8086汇编语言/media/image22.png)


当然可以让屏幕显示出字母也是可以的，比如打印a，看ASCII码表看97，然后转换十六进制为61，写入就行了。

![截图.png](    8086汇编语言/media/image23.png)
...
![截图.png](    8086汇编语言/media/image24.png)
...
![截图.png](    8086汇编语言/media/image25.png)
...
![截图.png](    8086汇编语言/media/image26.png)
...
![截图.png](    8086汇编语言/media/image27.png)


![截图.png](    8086汇编语言/media/image28.png)
...
![截图.png](    8086汇编语言/media/image29.png)
...
![截图.png](    8086汇编语言/media/image30.png)
...
![截图.png](    8086汇编语言/media/image31.png)
...
![截图.png](    8086汇编语言/media/image32.png)
...
![截图.png](    8086汇编语言/media/image33.png)
...
![截图.png](    8086汇编语言/media/image34.png)
...
![截图.png](    8086汇编语言/media/image35.png)
...
![截图.png](    8086汇编语言/media/image36.png)


例题

![截图.png](    8086汇编语言/media/image37.png)


![截图.png](    8086汇编语言/media/image38.png)


![截图.png](    8086汇编语言/media/image39.png)


![截图.png](    8086汇编语言/media/image40.png)
...
![截图.png](    8086汇编语言/media/image41.png)
...
![截图.png](    8086汇编语言/media/image42.png)


例题二

![截图.png](    8086汇编语言/media/image43.png)
...
![截图.png](    8086汇编语言/media/image44.png)
...
![截图.png](    8086汇编语言/media/image45.png)
...
![截图.png](    8086汇编语言/media/image46.png)


标号：一个标号指代了一个地址
，上面codesg就是一个标号，codesg放在assume前面作为一个段的名称，这个段最终被编译连接程序处理为一个段的段地址

![截图.png](    8086汇编语言/media/image47.png)
...
![截图.png](    8086汇编语言/media/image48.png)
...
![截图.png](    8086汇编语言/media/image49.png)


![截图.png](    8086汇编语言/media/image50.png)


![截图.png](    8086汇编语言/media/image51.png)
...
![截图.png](    8086汇编语言/media/image52.png)
...
![截图.png](    8086汇编语言/media/image53.png)
...
![截图.png](    8086汇编语言/media/image54.png)


4.6 以简化的方式进行编译和连接

![截图.png](    8086汇编语言/media/image55.png)
...
![截图.png](    8086汇编语言/media/image56.png)


编译连接的作用

![截图.png](    8086汇编语言/media/image57.png)
...
![截图.png](    8086汇编语言/media/image58.png)


4.8 可执行文件中的程序装入内存并运行的原理

![截图.png](    8086汇编语言/media/image59.png)
...
![截图.png](    8086汇编语言/media/image60.png)
...
![截图.png](    8086汇编语言/media/image61.png)
...
![截图.png](    8086汇编语言/media/image62.png)
...
![截图.png](    8086汇编语言/media/image63.png)
...
![截图.png](    8086汇编语言/media/image64.png)


段寄存器化成物理地址就要乘以十六，进一然后加上偏移地址

![截图.png](    8086汇编语言/media/image65.png)


作者想告诉我们这个运行程序的时候CS从0开始指向的下面就是存放代码的地方

![截图.png](    8086汇编语言/media/image66.png)


总结：

![截图.png](    8086汇编语言/media/image67.png)


![截图.png](    8086汇编语言/media/image68.png)
...
![截图.png](    8086汇编语言/media/image69.png)
...
![截图.png](    8086汇编语言/media/image70.png)
...
![截图.png](    8086汇编语言/media/image71.png)


定义描述性符合（）

![截图.png](    8086汇编语言/media/image72.png)


定义idata

![截图.png](    8086汇编语言/media/image73.png)
...
![截图.png](    8086汇编语言/media/image74.png)
...
![截图.png](    8086汇编语言/media/image75.png)
...
![截图.png](    8086汇编语言/media/image76.png)


使用loop的

![截图.png](    8086汇编语言/media/image77.png)


![截图.png](    8086汇编语言/media/image78.png)
...
![截图.png](    8086汇编语言/media/image79.png)


![截图.png](    8086汇编语言/media/image80.png)
...
![截图.png](    8086汇编语言/media/image81.png)


5.7 一段安全的空间

![截图.png](    8086汇编语言/media/image82.png)
...
![截图.png](    8086汇编语言/media/image83.png)


或者我们直接用debug操作，直接就退掉了

![截图.png](    8086汇编语言/media/image84.png)
...
![截图.png](    8086汇编语言/media/image85.png)
...
![截图.png](    8086汇编语言/media/image86.png)
...
![截图.png](    8086汇编语言/media/image87.png)
...
![截图.png](    8086汇编语言/media/image88.png)
...
![截图.png](    8086汇编语言/media/image89.png)
...
![截图.png](    8086汇编语言/media/image90.png)
...
![截图.png](    8086汇编语言/media/image91.png)
...
![截图.png](    8086汇编语言/media/image92.png)


dw可以放很多字型数据

![截图.png](    8086汇编语言/media/image93.png)


在4.9中数据过程追踪中学到过start:来指定程序的入口

![截图.png](    8086汇编语言/media/image94.png)


6.2在代码段中使用栈

![截图.png](    8086汇编语言/media/image95.png)
...
![截图.png](    8086汇编语言/media/image96.png)
...
![截图.png](    8086汇编语言/media/image97.png)


![截图.png](    8086汇编语言/media/image98.png)
...
![截图.png](    8086汇编语言/media/image99.png)


题目：

![截图.png](    8086汇编语言/media/image100.png)
...
![截图.png](    8086汇编语言/media/image101.png)
...
![截图.png](    8086汇编语言/media/image102.png)
...
使用dw定义字型数据，使用db定义字节数据，数据之间用逗号隔开，只有db可以用来定义字符串，因为字符串会被变成ASCII储存，如db
\'abcdefghijk\' ; 相当于 db
...
![截图.png](    8086汇编语言/media/image103.png)
...
![截图.png](    8086汇编语言/media/image104.png)
...
![截图.png](    8086汇编语言/media/image105.png)
...
![截图.png](    8086汇编语言/media/image106.png)
...
![截图.png](    8086汇编语言/media/image107.png)
...
![截图.png](    8086汇编语言/media/image108.png)
...
![截图.png](    8086汇编语言/media/image109.png)


题目

![截图.png](    8086汇编语言/media/image110.png)
...
![截图.png](    8086汇编语言/media/image111.png)
...
![截图.png](    8086汇编语言/media/image112.png)
...
![截图.png](    8086汇编语言/media/image113.png)


小题目压压惊

![截图.png](    8086汇编语言/media/image114.png)


7.10 不同的寻址方式的灵活应用

![截图.png](    8086汇编语言/media/image115.png)
...
![截图.png](    8086汇编语言/media/image116.png)
...
![截图.png](    8086汇编语言/media/image117.png)


这四个寄存器可以单个出现也可以组合出现

![截图.png](    8086汇编语言/media/image118.png)
...
![截图.png](    8086汇编语言/media/image119.png)
...
![截图.png](    8086汇编语言/media/image120.png)


（2）寄存器

![截图.png](    8086汇编语言/media/image121.png)
...
![截图.png](    8086汇编语言/media/image122.png)


这是，段地址默认在ds中

![截图.png](    8086汇编语言/media/image123.png)
...
![截图.png](    8086汇编语言/media/image124.png)
...
![截图.png](    8086汇编语言/media/image125.png)
...
![截图.png](    8086汇编语言/media/image126.png)


（2）在没有寄存器名存在的情况下，用操作符 X ptr 指明内存单元的长度，X
在汇编指令中可以为 word或byte

![截图.png](    8086汇编语言/media/image127.png)
...
![截图.png](    8086汇编语言/media/image128.png)
...
![截图.png](    8086汇编语言/media/image129.png)
...
5"。这个 "1 余 5" 就是
"除法溢出"，因为计算结果超出了你的计算器的显示能力。]

![截图.png](    8086汇编语言/media/image130.png)
...
![截图.png](    8086汇编语言/media/image131.png)


![截图.png](    8086汇编语言/media/image132.png)
...
![截图.png](    8086汇编语言/media/image133.png)
...
![截图.png](    8086汇编语言/media/image134.png)


![截图.png](    8086汇编语言/media/image135.png)


实验七：

![截图.png](    8086汇编语言/media/image136.png)


![截图.png](    8086汇编语言/media/image137.png)


![截图.png](    8086汇编语言/media/image138.png)
...
![截图.png](    8086汇编语言/media/image139.png)
...
![截图.png](    8086汇编语言/media/image140.png)
...
操作符offset在汇编语言中是由编译器处理的符号，他的功能是取得标号的偏移地址的值如果想跳转就把值修改到IP里面就可以实现跳转

![截图.png](    8086汇编语言/media/image141.png)
...
![截图.png](    8086汇编语言/media/image142.png)
...
![截图.png](    8086汇编语言/media/image143.png)
...
![截图.png](    8086汇编语言/media/image144.png)


一般在汇编指令中，汇编指令中的idata（立即数），不论表示的是一个数据还是内存单元的偏移地址,在机械代码中都是对应出现的，因为CPU执行的是机器指令，它必须要处理这些数据和地址。

![截图.png](    8086汇编语言/media/image145.png)


![截图.png](    8086汇编语言/media/image146.png)
...
![截图.png](    8086汇编语言/media/image147.png)


![截图.png](    8086汇编语言/media/image148.png)
...
![截图.png](    8086汇编语言/media/image149.png)
...
![截图.png](    8086汇编语言/media/image150.png)
...
![截图.png](    8086汇编语言/media/image151.png)


![截图.png](    8086汇编语言/media/image152.png)


这里我一开始是写 dw
0,5但是这是错的，因为data已近赋值给了ax所以这里的第一个指令的偏移地址就是0，这里我原理记错了，导致失误

![截图.png](    8086汇编语言/media/image153.png)


所以应该是 dw 0,0或者 dw 2 dup (0)

![截图.png](    8086汇编语言/media/image154.png)
...
![截图.png](    8086汇编语言/media/image155.png)
...
![截图.png](    8086汇编语言/media/image156.png)


当然我们可以改cl和ch来改cx的值

![截图.png](    8086汇编语言/media/image157.png)
...
![截图.png](    8086汇编语言/media/image158.png)
...
![截图.png](    8086汇编语言/media/image159.png)
...
![截图.png](    8086汇编语言/media/image160.png)


第九章总结

offset在汇编语言中是取得标号的偏移地址，也就是IP的值
...
![截图.png](    8086汇编语言/media/image161.png)
...
![截图.png](    8086汇编语言/media/image162.png)
...
![截图.png](    8086汇编语言/media/image163.png)


检查点：

![截图.png](    8086汇编语言/media/image164.png)
...
![截图.png](    8086汇编语言/media/image165.png)
...
![截图.png](    8086汇编语言/media/image166.png)
...
![截图.png](    8086汇编语言/media/image167.png)
...
![截图.png](    8086汇编语言/media/image168.png)
...
![截图.png](    8086汇编语言/media/image169.png)
...
![截图.png](    8086汇编语言/media/image170.png)
...
![截图.png](    8086汇编语言/media/image171.png)
...
![截图.png](    8086汇编语言/media/image172.png)
...
![截图.png](    8086汇编语言/media/image173.png)
...
![截图.png](    8086汇编语言/media/image174.png)
...
![截图.png](    8086汇编语言/media/image175.png)


成功拿捏

![截图.png](    8086汇编语言/media/image176.png)
...
![截图.png](    8086汇编语言/media/image177.png)
...
![截图.png](    8086汇编语言/media/image178.png)
...
![截图.png](    8086汇编语言/media/image179.png)


![截图.png](    8086汇编语言/media/image180.png)
...
![截图.png](    8086汇编语言/media/image181.png)


两个简单例题

![截图.png](    8086汇编语言/media/image182.png)
...
![截图.png](    8086汇编语言/media/image183.png)
...
![截图.png](    8086汇编语言/media/image184.png)
...
![截图.png](    8086汇编语言/media/image185.png)
...
![截图.png](    8086汇编语言/media/image186.png)
...
![截图.png](    8086汇编语言/media/image187.png)


![截图.png](    8086汇编语言/media/image188.png)


![截图.png](    8086汇编语言/media/image189.png)


他这里直接把si改成0，不知道自己检测，感觉奇怪的

![截图.png](    8086汇编语言/media/image190.png)
...
![截图.png](    8086汇编语言/media/image191.png)
...
![截图.png](    8086汇编语言/media/image192.png)


当然解决这个问题的办法就是，在子程序开始将子程序所用到的所有寄存器内容保存起来，在子程序运行完成后恢复，可以用栈来保存寄存器中的内容。

![截图.png](    8086汇编语言/media/image193.png)
...
![截图.png](    8086汇编语言/media/image194.png)
...
![截图.png](    8086汇编语言/media/image195.png)
...
![截图.png](    8086汇编语言/media/image196.png)
...
![截图.png](    8086汇编语言/media/image197.png)
...
![截图.png](    8086汇编语言/media/image198.png)
...
![截图.png](    8086汇编语言/media/image199.png)
...
![截图.png](    8086汇编语言/media/image200.png)


下面这个程序，如果是有符号位就是溢出，无符号位就是进位 OF=1 ,CF=1

![截图.png](    8086汇编语言/media/image201.png)
...
![截图.png](    8086汇编语言/media/image202.png)
...
![截图.png](    8086汇编语言/media/image203.png)
...
![截图.png](    8086汇编语言/media/image204.png)
...
![截图.png](    8086汇编语言/media/image205.png)
...
![截图.png](    8086汇编语言/media/image206.png)


可以根据这些反推

![截图.png](    8086汇编语言/media/image207.png)
...
![截图.png](    8086汇编语言/media/image208.png)
...
![截图.png](    8086汇编语言/media/image209.png)
...
![截图.png](    8086汇编语言/media/image210.png)


![截图.png](    8086汇编语言/media/image211.png)
...
![截图.png](    8086汇编语言/media/image212.png)
...
![截图.png](    8086汇编语言/media/image213.png)
...
![截图.png](    8086汇编语言/media/image214.png)
...
![截图.png](    8086汇编语言/media/image215.png)
...
![截图.png](    8086汇编语言/media/image216.png)
...
![截图.png](    8086汇编语言/media/image217.png)
...
![截图.png](    8086汇编语言/media/image218.png)


![截图.png](    8086汇编语言/media/image219.png)
...
![截图.png](    8086汇编语言/media/image220.png)
...
![截图.png](    8086汇编语言/media/image221.png)


设置中断向量表，然后就使用就跳转do0执行do0

![截图.png](    8086汇编语言/media/image222.png)


概括一下下一节就详细讲。

![截图.png](    8086汇编语言/media/image223.png)
...
![截图.png](    8086汇编语言/media/image224.png)
...
![截图.png](    8086汇编语言/media/image225.png)
...
![截图.png](    8086汇编语言/media/image226.png)
...
![截图.png](    8086汇编语言/media/image227.png)
...
![截图.png](    8086汇编语言/media/image228.png)
...
![截图.png](    8086汇编语言/media/image229.png)
...
![截图.png](    8086汇编语言/media/image230.png)
...
![截图.png](    8086汇编语言/media/image231.png)
...
![截图.png](    8086汇编语言/media/image232.png)
...
![截图.png](    8086汇编语言/media/image233.png)


iret恢复。

![截图.png](    8086汇编语言/media/image234.png)
...
![截图.png](    8086汇编语言/media/image235.png)


最大应该是FFFFh,十进制是65536

[2、 用7ch中断例程完成jmp near ptr
s指令功能，用bx向中断例程传送转移位移。]
...
![截图.png](    8086汇编语言/media/image236.png)
...
![截图.png](    8086汇编语言/media/image237.png)
...
![截图.png](    8086汇编语言/media/image238.png)
...
![截图.png](    8086汇编语言/media/image239.png)


![截图.png](    8086汇编语言/media/image240.png)
...
![截图.png](    8086汇编语言/media/image241.png)
...
![截图.png](    8086汇编语言/media/image242.png)
...
![截图.png](    8086汇编语言/media/image243.png)


![截图.png](    8086汇编语言/media/image244.png)
...
![截图.png](    8086汇编语言/media/image245.png)
...
![截图.png](    8086汇编语言/media/image246.png)


![截图.png](    8086汇编语言/media/image247.png)
...
![截图.png](    8086汇编语言/media/image248.png)


原理：左移一位就要乘以进制数，比如10左移就是100就是乘了10,而左移指令就是乘以了2进行了左移。

![截图.png](    8086汇编语言/media/image249.png)
...
![截图.png](    8086汇编语言/media/image250.png)
...
![截图.png](    8086汇编语言/media/image251.png)


![截图.png](    8086汇编语言/media/image252.png)
...
![截图.png](    8086汇编语言/media/image253.png)
...
![截图.png](    8086汇编语言/media/image254.png)
...
![截图.png](    8086汇编语言/media/image255.png)
...
![截图.png](    8086汇编语言/media/image256.png)
...
![截图.png](    8086汇编语言/media/image257.png)
...
![截图.png](    8086汇编语言/media/image258.png)
...
![截图.png](    8086汇编语言/media/image259.png)
...
![截图.png](    8086汇编语言/media/image260.png)
...
![截图.png](    8086汇编语言/media/image261.png)
...
![截图.png](    8086汇编语言/media/image262.png)


检测点15.1

![截图.png](    8086汇编语言/media/image263.png)


![截图.png](    8086汇编语言/media/image264.png)
...
![截图.png](    8086汇编语言/media/image265.png)
...
![截图.png](    8086汇编语言/media/image266.png)


实验15

![截图.png](    8086汇编语言/media/image267.png)
...
![截图.png](    8086汇编语言/media/image268.png)
...
![截图.png](    8086汇编语言/media/image269.png)
...
![截图.png](    8086汇编语言/media/image270.png)
...
![截图.png](    8086汇编语言/media/image271.png)
...
![截图.png](    8086汇编语言/media/image272.png)
...
![截图.png](    8086汇编语言/media/image273.png)
...
![截图.png](    8086汇编语言/media/image274.png)
...
![截图.png](    8086汇编语言/media/image275.png)
...
![截图.png](    8086汇编语言/media/image276.png)
...
![截图.png](    8086汇编语言/media/image277.png)
...
![截图.png](    8086汇编语言/media/image278.png)
...
![截图.png](    8086汇编语言/media/image279.png)
...
![截图.png](    8086汇编语言/media/image280.png)
...
![截图.png](    8086汇编语言/media/image281.png)
...
![截图.png](    8086汇编语言/media/image282.png)
