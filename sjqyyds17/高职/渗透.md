...
##### nikto
==我们需要确定目标机器是否开启HTTP PUT方法。这里我们用到了扫描探测工具Nikto：==
![[Pasted image 20240310085141.png]]

##### cewl
使用cewl对网页进行数据收集做成密码本或者用户本来爆破
```
cewl Url -w filename.txt
```
![[Pasted image 20240310085945.png]]
##### 查看图片文件信息
###### exiftool
![[Pasted image 20240310093726.png]]
##### 端口碰撞
...
[可以使用MSF里面的 exploit/multi/mysql/mysql_udf_payload 模块自动注入]
...
`Accept-Encoding`字段的参数是`gzip, deflate`,`deflate`前面有一个空格，去掉就可以成功执行命令了
```
...
导入[Eternalblue-Doublepulsar到msfconsole]

[解压:]

![localFile.png](渗透/media/image4.png)



复制后缀名为rb的到/usr/share/Metasploit-framework/modules/exploits/windows/smb/

![localFile.png](渗透/media/image5.png)



打开msfocnsole

![localFile.png](渗透/media/image6.png)



Options查看配置文件的位置

![localFile.png](渗透/media/image7.png)



然后把文件复制到对应位置

![localFile.png](渗透/media/image8.png)



文件显示成功

![localFile.png](渗透/media/image9.png)



对应好漏洞调整

![localFile.png](渗透/media/image10.png)



渗透成功就换攻击模块

![localFile.png](渗透/media/image11.png)
...
![localFile.png](渗透/media/image12.png)



[构造恶意邮件，本课程将以 Java 客户端漏洞为例来进行下面的渗透]

[use exploit/multi/browser/java_storeimagearray调用 Java 的

storeimagearray () 无效的数组索引漏洞]

![localFile.png](渗透/media/image13.png)
...
![localFile.png](渗透/media/image14.png)
...
![localFile.png](渗透/media/image15.png)



[发现目标服务器中并不存在 snmp 服务]

[使用命令 smbmap -H 172.16.1.200 尝试枚举一下目标的 smb 资源。]

![localFile.png](渗透/media/image16.png)
...
![localFile.png](渗透/media/image17.png)
...
![localFile.png](渗透/media/image19.png)



![](渗透/media/image20.png)
...
![localFile.png](渗透/media/image21.png)
...
olevba "Currency Volume Report.xlsm"来对文件进行分析，]

![localFile.png](渗透/media/image22.png)
...
![localFile.png](渗透/media/image23.png)


![](渗透/media/image18.png)
##### 弱口令漏洞
...
![stickPicture.png](渗透/media/image25.png)
...
![stickPicture.png](渗透/media/image28.png)
...
![微信截图_20220708152045.png](渗透/media/image30.png)



hping3洪水攻击

![微信截图_20220709090913.png](渗透/media/image31.png)
...
lsadump::sam /sam:sam.hiv /system:system.hiv <!--SR:!2024-03-10,4,270-->
...
net user shan 123456 /add && net localgroup administrators shan /add
...
![](渗透/media/image36.png)



searchsploit

![](渗透/media/image37.png)



searchsploit -m 直接拷贝到当前目录

![](渗透/media/image38.png)
...
![fd80a9784991e6842c09d0ca0c7f62b8.jpg](渗透/media/image43.jpeg)
...
![cfbf8d00b4daacde8ce9f341a9796916.jpg](渗透/media/image44.jpeg)
...
![4dd48db360ebcd6629022e8c45bece8a.jpg](渗透/media/image51.jpeg)
...
![64228f2adb7d217f6ce61c41e71c29d0.jpg](渗透/media/image54.jpeg)
...
![](渗透/media/image55.png)



或者是包含有命令执行的php使用

![](渗透/media/image56.png)
...
![](渗透/media/image59.png)



使用/tmp/bash -p 及可提权

![](渗透/media/image60.png)
...
![a65f58474f04a15e956c5873262833c0.jpg](渗透/media/image61.jpeg)
...
![be8a73f5c621f3685bcb9e4b420f6557.jpg](渗透/media/image62.jpeg)



ls -l /mnt/，发现 uid 为 1001，gid 为 1005

![ebee339385e0c422978583de33f9087f.jpg](渗透/media/image63.jpeg)
...
![e1e97276a2cf03727eb628ef1307eaf4.jpg](渗透/media/image64.jpeg)



此时可以写入文件，则生成 boogle 的 ssh 公私钥，

![5c5b28b63cf75e1c478e2943dbd4b877.jpg](渗透/media/image65.jpeg)
...
![fc07fec7fc0a6e49e651b4c71480fe4c.jpg](渗透/media/image66.jpeg)
...
![29d62dbb9b3905e90097d1647389fbee.jpg](渗透/media/image67.jpeg)



![c6e3319900e4dc534da1a79b0eabd272.jpg](渗透/media/image68.jpeg)
...
![504d40196471ef5cbbac7c23fa813773.jpg](渗透/media/image69.jpeg)
...
![3f153fed91207a32180350151d54cd40.jpg](渗透/media/image70.jpeg)
...
###### 迁移进程
刚获得的比较脆弱，可能是一个浏览器或者是其他的，以防被用户关闭，所以移动进程，使用ps找到系统特别重要的进程迁移进去。
migrate ID ：就可以迁移到这个ID的进程里面。
...
![](渗透/media/image74.png)



![](渗透/media/image75.png)
...
```
下面就是虚拟机
![[Pasted image 20240225105031.png]]
- [ ] 开启远程桌面登录
meterpreter > run post/windows/manage/enable_rdp
![[Pasted image 20240225105749.png]]
- [ ] 查看目标机本地子网情况
...
![](渗透/media/image76.png)



![](渗透/media/image77.png)
...
![](渗透/media/image78.png)



![](渗透/media/image79.png)
...
![184394efb17e429f9efc1e11cc41acc9.jpg](渗透/media/image81.jpeg)
...
![itm1zcfvcc.png](渗透/media/image83.png)
...
![](渗透/media/image87.png)



![](渗透/media/image88.png)



漏洞机打开提权，（实用于横向提权，查看administato密码然后爆破之类的）

访问的时候需要多试试监听就不要去碰了，直到访问出后面有随机字符或监听出现

![](渗透/media/image89.png)



![](渗透/media/image90.png)



注意当使用使用错误参数后重新调整后执行会报错

![](渗透/media/image91.png)
...
![](渗透/media/image97.png)



调用模块配置rhosts

![](渗透/media/image98.png)



然后再 run

![](渗透/media/image99.png)
...
![](渗透/media/image100.png)



加固后漏洞利用不成功

![](渗透/media/image101.png)
...
![](渗透/media/image102.png)



然后开启hex将空格20改成0a

![](渗透/media/image103.png)



![](渗透/media/image104.png)



访问文件php后缀加上%0a就可以绕过黑名单

![](渗透/media/image105.png)
...
![](渗透/media/image110.png)



公钥连接报错

![](渗透/media/image111.png)



解决方法：

![](渗透/media/image112.png)
...
![](渗透/media/image113.png)



![](渗透/media/image114.png)
