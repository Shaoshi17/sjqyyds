...
![image.png](    赛题环境解析/media/image1.png)
...
![image.png](    赛题环境解析/media/image2.png)
...
![image.png](    赛题环境解析/media/image3.png)
...
![截图.png](    赛题环境解析/media/image10.png)


![截图.png](    赛题环境解析/media/image11.png)


2.使用访问工具对服务器服务访问， 将查看到最后一个文件的共享名称作为 flag
提交；

![截图.png](    赛题环境解析/media/image12.png)


3.使用访问工具对服务器服务访问，
将服务器中管理员桌面的文本文档里的内容作为 flag 提交；

![截图.png](    赛题环境解析/media/image13.png)


4.使用访问工具对服务器服务访问， 将服务器中DNS2 的地址作为 flag 提交；

![截图.png](    赛题环境解析/media/image14.png)


5.使用访问工具对服务器服务访问， 将服务器中最后一个用户名作为 flag
提交；

![截图.png](    赛题环境解析/media/image15.png)
...
![截图.png](    赛题环境解析/media/image16.png)


![截图.png](    赛题环境解析/media/image17.png)
...
![截图.png](    赛题环境解析/media/image18.png)
...
![截图.png](    赛题环境解析/media/image19.png)


4.对results.pcap数据包文件进行分析，将过滤语句作为FLAG提交；(不包含空格)

![截图.png](    赛题环境解析/media/image20.png)
...
![截图.png](    赛题环境解析/media/image21.png)


2.设置密码复杂程度，允许重试3次，新密码必须与旧密码有4位不同，最小位数6位，大写字母至少包含2位，小写字母至少包含3位，特殊字母个数至少包含1位，将配置文件中对应的部分截图;

![截图.png](    赛题环境解析/media/image22.png)


3.禁止匿名用户登录vsftpd服务，将配置文件中对应的部分截图；

![截图.png](    赛题环境解析/media/image23.png)


4.设置关闭ftp-data端口不使用主动模式，使用ipv4进行监听，将配置文件中对应的部分截图；

![截图.png](    赛题环境解析/media/image24.png)


![截图.png](    赛题环境解析/media/image25.png)


5. 将Telnet服务的端口号修改为2323 ,查看Telnet服务端口信息，将回显结果截图；

![截图.png](    赛题环境解析/media/image26.png)


![截图.png](    赛题环境解析/media/image27.png)
...
![截图.png](    赛题环境解析/media/image28.png)
...
![截图.png](    赛题环境解析/media/image29.png)


9.修改网站的httpd服务为root权限，将配置文件中对应的部分截图；

![截图.png](    赛题环境解析/media/image30.png)
...
![截图.png](    赛题环境解析/media/image39.png)


![截图.png](    赛题环境解析/media/image40.png)
...
![截图.png](    赛题环境解析/media/image41.png)


![截图.png](    赛题环境解析/media/image42.png)


![截图.png](    赛题环境解析/media/image43.png)


![截图.png](    赛题环境解析/media/image44.png)
...
![截图.png](    赛题环境解析/media/image45.png)
...
![截图.png](    赛题环境解析/media/image46.png)


![截图.png](    赛题环境解析/media/image47.png)
...
![截图.png](    赛题环境解析/media/image48.png)


![截图.png](    赛题环境解析/media/image49.png)
...
![image.png](    赛题环境解析/media/image50.png)
...
![截图.png](    赛题环境解析/media/image57.png)
...
![截图.png](    赛题环境解析/media/image58.png)


![截图.png](    赛题环境解析/media/image59.png)
...
![截图.png](    赛题环境解析/media/image60.png)


![截图.png](    赛题环境解析/media/image61.png)


![截图.png](    赛题环境解析/media/image62.png)
...
![截图.png](    赛题环境解析/media/image63.png)
...
![截图.png](    赛题环境解析/media/image64.png)
...
![截图.png](    赛题环境解析/media/image65.png)
...
![截图.png](    赛题环境解析/media/image66.png)
...
![截图.png](    赛题环境解析/media/image67.png)
...
![截图.png](    赛题环境解析/media/image68.png)


> 这个是\[80\]

![截图.png](    赛题环境解析/media/image69.png)
...
![截图.png](    赛题环境解析/media/image75.png)


2.   使用渗透机对服务器信息收集，并将服务器中主机名称作为flag提交；

![截图.png](    赛题环境解析/media/image76.png)


3.   使用渗透机对服务器信息收集，并将服务器中系统内核版本作为flag提交；

![截图.png](    赛题环境解析/media/image77.png)


4.  
使用渗透机对服务器管理员提权，并将服务器中root目录下的文本内容作为flag提交；

![截图.png](    赛题环境解析/media/image78.png)


![截图.png](    赛题环境解析/media/image79.png)


![截图.png](    赛题环境解析/media/image80.png)


![截图.png](    赛题环境解析/media/image81.png)


![截图.png](    赛题环境解析/media/image82.png)
...
![截图.png](    赛题环境解析/media/image83.png)
...
![截图.png](    赛题环境解析/media/image84.png)
...
![截图.png](    赛题环境解析/media/image92.png)
...
![截图.png](    赛题环境解析/media/image93.png)
...
![截图.png](    赛题环境解析/media/image102.png)
...
![截图.png](    赛题环境解析/media/image103.png)
...
![截图.png](    赛题环境解析/media/image104.png)


getsystem提权成功

![截图.png](    赛题环境解析/media/image105.png)


![截图.png](    赛题环境解析/media/image106.png)
...
![截图.png](    赛题环境解析/media/image107.png)
...
![截图.png](    赛题环境解析/media/image108.png)
...
![截图.png](    赛题环境解析/media/image109.png)
...
![截图.png](    赛题环境解析/media/image110.png)
...
![截图.png](    赛题环境解析/media/image111.png)


![截图.png](    赛题环境解析/media/image112.png)
...
![截图.png](    赛题环境解析/media/image113.png)
...
![截图.png](    赛题环境解析/media/image114.png)


![截图.png](    赛题环境解析/media/image115.png)
...
![截图.png](    赛题环境解析/media/image118.png)
...
![截图.png](    赛题环境解析/media/image123.png)


6.通过本地PC中渗透测试平台Kali2.0对服务器场景PYsystemWH5进行渗透测试，将该场景中的当前最高账户管理员的密码作为Flag值提交；（20分）

![截图.png](    赛题环境解析/media/image124.png)


![截图.png](    赛题环境解析/media/image125.png)


![截图.png](    赛题环境解析/media/image126.png)


7.通过本地PC中渗透测试平台Kali2.0对服务器场景PYsystemWH5进行渗透测试，将该场景中回收站内文件的文档内容作为Flag值提交。（21分）

![截图.png](    赛题环境解析/media/image127.png)
...
![截图.png](    赛题环境解析/media/image128.png)
...
![截图.png](    赛题环境解析/media/image139.png)
...
![截图.png](    赛题环境解析/media/image140.png)
...
![截图.png](    赛题环境解析/media/image141.png)
...
![截图.png](    赛题环境解析/media/image142.png)
...
![截图.png](    赛题环境解析/media/image143.png)
...
![截图.png](    赛题环境解析/media/image144.png)
...
![截图.png](    赛题环境解析/media/image145.png)
...
![image.png](    赛题环境解析/media/image146.png)


3\.
利用Kali渗透机生成反弹木马，将生成木马命令执行后提示的第四行的首个单词作为FLAG（形式：\[单词\]）提交；（1分）

![image.png](    赛题环境解析/media/image147.png)
...
![截图.png](    赛题环境解析/media/image153.png)
...
![截图.png](    赛题环境解析/media/image154.png)
...
![截图.png](    赛题环境解析/media/image155.png)
...
![截图.png](    赛题环境解析/media/image156.png)
...
![截图.png](    赛题环境解析/media/image157.png)
...
![截图.png](    赛题环境解析/media/image167.png)
...
![截图.png](    赛题环境解析/media/image174.png)
...
![image.png](    赛题环境解析/media/image175.png)


2. 获取靶机Server2129系统中以英文"P"开头的用户名，并将该用户名作为Flag值提交；

![image.png](    赛题环境解析/media/image176.png)


![image.png](    赛题环境解析/media/image177.png)


![image.png](    赛题环境解析/media/image178.png)


3. 找到靶机Server2129的网络适配器信息，将首选DNS服务器地址作为Flag值提交；

![image.png](    赛题环境解析/media/image179.png)


4. 找到靶机Server2129中桌面上111文件夹中后缀为.docx的文件，将文档内容作为Flag值提交；

![image.png](    赛题环境解析/media/image180.png)


![image.png](    赛题环境解析/media/image181.png)


5. 找到靶机Server2129中回收站内的文档，将文档内容作为Flag值提交；

![image.png](    赛题环境解析/media/image182.png)


6. 找到靶机Server2129中的C:\\flag.txt文件，将文件的内容作为Flag值提交。

![image.png](    赛题环境解析/media/image183.png)
...
![截图.png](    赛题环境解析/media/image184.png)
...
![截图.png](    赛题环境解析/media/image185.png)
...
![截图.png](    赛题环境解析/media/image186.png)


![截图.png](    赛题环境解析/media/image187.png)
...
![截图.png](    赛题环境解析/media/image188.png)


![截图.png](    赛题环境解析/media/image189.png)


搜索flag.txt文件

![截图.png](    赛题环境解析/media/image190.png)


![截图.png](    赛题环境解析/media/image191.png)
...
![截图.png](    赛题环境解析/media/image195.png)
...
![截图.png](    赛题环境解析/media/image196.png)
...
![截图.png](    赛题环境解析/media/image197.png)
...
![截图.png](    赛题环境解析/media/image198.png)
...
![截图.png](    赛题环境解析/media/image199.png)
...
![截图.png](    赛题环境解析/media/image200.png)
...
![截图.png](    赛题环境解析/media/image201.png)
...
![截图.png](    赛题环境解析/media/image202.png)
...
![截图.png](    赛题环境解析/media/image203.png)
...
![截图.png](    赛题环境解析/media/image204.png)
...
![截图.png](    赛题环境解析/media/image205.png)
...
![截图.png](    赛题环境解析/media/image206.png)
...
![截图.png](    赛题环境解析/media/image207.png)
...
![截图.png](    赛题环境解析/media/image208.png)
...
![截图.png](    赛题环境解析/media/image209.png)
...
![截图.png](    赛题环境解析/media/image210.png)
...
![截图.png](    赛题环境解析/media/image211.png)
...
![截图.png](    赛题环境解析/media/image212.png)
...
![截图.png](    赛题环境解析/media/image213.png)


![截图.png](    赛题环境解析/media/image214.png)


![截图.png](    赛题环境解析/media/image215.png)


4. 通过本地PC中渗透测试平台Kali2.0对服务器场景PYsystemWH4进行渗透测试，将该场景的内核版本号作为Flag值（例如：2.6.18）提交；

![截图.png](    赛题环境解析/media/image216.png)
...
![截图.png](    赛题环境解析/media/image217.png)
...
![截图.png](    赛题环境解析/media/image227.png)


![截图.png](    赛题环境解析/media/image228.png)
...
![截图.png](    赛题环境解析/media/image229.png)
...
![截图.png](    赛题环境解析/media/image230.png)
...
![截图.png](    赛题环境解析/media/image231.png)


有一根平行的细线（找到只需一个万花筒）

![截图.png](    赛题环境解析/media/image232.png)


发现只有一个red有说明是red低位隐写

![截图.png](    赛题环境解析/media/image233.png)
...
![截图.png](    赛题环境解析/media/image234.png)


![截图.png](    赛题环境解析/media/image235.png)
...
![截图.png](    赛题环境解析/media/image236.png)
...
![截图.png](    赛题环境解析/media/image237.png)
...
![截图.png](    赛题环境解析/media/image238.png)
...
![截图.png](    赛题环境解析/media/image239.png)
...
![截图.png](    赛题环境解析/media/image240.png)
...
![截图.png](    赛题环境解析/media/image241.png)


![截图.png](    赛题环境解析/media/image242.png)
...
![截图.png](    赛题环境解析/media/image243.png)
...
![截图.png](    赛题环境解析/media/image244.png)
...
![截图.png](    赛题环境解析/media/image245.png)
...
![截图.png](    赛题环境解析/media/image246.png)
...
![截图.png](    赛题环境解析/media/image247.png)
...
![截图.png](    赛题环境解析/media/image248.png)


6. 将私钥文件进行格式转换后进行解密，将成功解密出的密码作为FLAG提交；

![截图.png](    赛题环境解析/media/image249.png)


7. 利用靶机服务器上的溢出程序进行提权，将接收用户输入的缓冲区的大小作为FLAG提交；

![截图.png](    赛题环境解析/media/image250.png)
...
![截图.png](    赛题环境解析/media/image251.png)


9. 利用上述漏洞源码后将获得到的靶机/root下的唯一.txt文件的文件内容作为FLAG（形式：\[文件内容\]）提交。

![截图.png](    赛题环境解析/media/image252.png)
...
![截图.png](    赛题环境解析/media/image260.png)
...
![截图.png](    赛题环境解析/media/image261.png)


![截图.png](    赛题环境解析/media/image262.png)
...
![截图.png](    赛题环境解析/media/image263.png)


![截图.png](    赛题环境解析/media/image264.png)
...
![localFile.png](    赛题环境解析/media/image265.png)


![截图.png](    赛题环境解析/media/image266.png)
...
![截图.png](    赛题环境解析/media/image267.png)
...
![localFile.png](    赛题环境解析/media/image268.png)
...
![截图.png](    赛题环境解析/media/image269.png)
